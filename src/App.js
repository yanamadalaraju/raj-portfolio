...
import { FaSun, FaMoon ,FaBox, FaRobot, FaDatabase,FaGithub, FaLinkedin, FaWhatsapp, FaInstagram, FaEnvelope,FaBars, FaTimes } from "react-icons/fa";
import "./App.css";
import "./Navbar.css";
import "./Sections.css";
import "./About.css"; 
...
import stockImage from "../src/images/side.avif";
import chatbotImage from "../src/images/program.jpg";
import databaseImage from "../src/images/frontend.jpg";
import "./Projects.css";
  ...
  const projects = [
    {
      ...
      description: "Developed a Stock Management System using React, Bootstrap, and Node.js, ensuring efficient inventory tracking and management.LOGIN CREDENTIALS -->'Email:admin@gmail.com',password:admin@123",
      image: stockImage,
    ...
    {
      title: "AI Chatbot",
      description: "An interactive AI-powered chatbot for customer support and automation.",
      image: chatbotImage,
    ...
    },
    {
      ...
      description: "A smart AI-based database management system for optimized querying.",
      image: databaseImage,
  ...
  return (
    <div className={darkMode ? "dark-mode" : "light-mode"}>
      ...
      <button className="theme-toggle" onClick={() => setDarkMode(!darkMode)}>
        {darkMode ? <FaSun size={24} color="#fdd835" /> : <FaMoon size={24} color="#4a90e2" />}
      </button>
    </nav>
...
<section id="home" className="section">
  ...
  >
    ...
    >
      A <span className="highlight">Python Full Stack Developer</span> passionate about
      crafting scalable web applications with seamless user experiences.
    </motion.p>
      ...
      >
        ...
        <div className="about-content">
          <motion.img 
            ...
            whileHover={{ scale: 1.1, rotate: 5, boxShadow: "0px 0px 20px rgba(255, 91, 91, 0.8)" }}
          />
          <div className="about-text">
            ...
            >
              I am a passionate <span className="highlight">Fullstack Developer</span> with expertise in 
              **React, JavaScript, Python, Django, and modern UI/UX** principles. I love crafting **scalable web applications** and seamless user experiences.
            </motion.p>
          </div>
        </div>
      ...
      <AnimatePresence>
        {popupType && (
          ...
          >
            ...
            >
              <h3>{popupType === "personal" ? "Personal Info" : "Education Details"}</h3>
              <p>
                {popupType === "personal"
  ...
  <div className="projects-grid">
    {projects.map((project, index) => (
      <motion.div
        ...
        animate={{ opacity: 1, scale: 1 }}
        whileHover={{ scale: 1.05, rotateX: 10, boxShadow: "0px 10px 30px rgba(255, 215, 0, 0.7)" }}
        transition={{ duration: 0.5, delay: index * 0.2 }}
      >
...
<section id="contact" className="contact-section">
      ...
      <div className="contact-container">
        ...
        <motion.div
          ...
          initial={{ opacity: 0, x: -50 }}
          animate={{ opacity: 1, x: 0 }}
          whileHover={{ scale: 1.05, boxShadow: "0px 5px 20px rgba(0, 255, 255, 0.5)" }}
          transition={{ duration: 0.5 }}
        >
          <img src={profilePic} alt="Profile" className="contact-profile-pic" />
          <h3>Rajesh Yanamadala</h3>
          <p><strong>📍 Location:</strong> Hyderabad, India</p>
          <p><strong>📧 Email:</strong> rajeshyanamadala2000@gmail.com</p>
          <p><strong>📞 Contact:</strong> +91 9346843156</p>
        ...
        <motion.div
          ...
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
          whileHover={{ scale: 1.05, boxShadow: "0px 5px 20px rgba(255, 105, 180, 0.5)" }}
          transition={{ duration: 0.5 }}
        >
          <h3>Connect with Me 🌐</h3>
          <div className="social-icons">
            <motion.a href="https://github.com/yanamadalaraju" target="_blank" whileHover={{ scale: 1.2 }}>
              <FaGithub />
            </motion.a>
            <motion.a href="https://www.linkedin.com/in/yanamadala-rajesh-999834233/" target="_blank" whileHover={{ scale: 1.2 }}>
              <FaLinkedin />
            </motion.a>
            <motion.a href="https://wa.me/9346843156" target="_blank" whileHover={{ scale: 1.2 }}>
              <FaWhatsapp />
            </motion.a>
            <motion.a href="https://www.instagram.com/__rajesh__21_/?hl=en" target="_blank" whileHover={{ scale: 1.2 }}>
              <FaInstagram />
            </motion.a>
            <motion.a href="mailto:rajeshyanamadala2000@gmail.com" whileHover={{ scale: 1.2 }}>
              <FaEnvelope />
            </motion.a>
          </div>
